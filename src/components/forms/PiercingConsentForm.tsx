...
const CONSENT_TEXT = `I hereby consent to the piercing procedure described above. I confirm that I have provided truthful information. I understand the risks involved including, but not limited to, infection, allergic reaction, scarring, migration, rejection, and nerve damage. I acknowledge that healing times vary and I agree to follow all aftercare instructions provided by the studio. I confirm that I am not under the influence of alcohol or drugs.`;
